package com.multithreading.udemy.forkjoin.forkjoin1;

import java.util.concurrent.ForkJoinPool;
import java.util.concurrent.RecursiveAction;


public class SimpleRecursiveActionEx {
...
class SimpleRecursiveAction extends RecursiveAction {
	...
	protected void compute() {
		...
		if( simulatedWork > 100 ) {
			...
			com.multithreading.udemy.forkjoin.forkjoin1.SimpleRecursiveAction simpleRecursiveAction1 = new SimpleRecursiveAction(simulatedWork/2);
			com.multithreading.udemy.forkjoin.forkjoin1.SimpleRecursiveAction simpleRecursiveAction2 = new SimpleRecursiveAction(simulatedWork/2);
